...
public class FlickrFetchr {
    ...
    public static final String ENDPOINT = "https://api.flickr.com/services/rest"; //Flickr now uses https. http doesn't work.
    public static final String API_KEY = "6fc98ef930de30fd320903fef6358fa8";
